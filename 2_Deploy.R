...
# test version deploy
rsconnect::deployApp(appDir="App Files", appName="MetricsCOSEWIC_App_Testing",appTitle="MetricsCOSEWIC_App_Testing")

# deploy the app
rsconnect::deployApp(appDir="App Files", appTitle="MetricsCOSEWIC_App")

rsconnect::showLogs(appPath="App Files", appFile="MetricsCOSEWIC_App")
